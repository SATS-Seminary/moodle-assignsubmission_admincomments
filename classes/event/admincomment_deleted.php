...
/**
 * The assignsubmission_admincomments admincomment deleted event.
 *
...
class admincomment_deleted extends \core\event\comment_deleted {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the admincomment with id '$this->objectid' from the submission " .
